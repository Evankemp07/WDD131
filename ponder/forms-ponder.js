...
form.addEventListener("submit", function (event) {
  ...
  if (type === "many" && note === "") {
    output.textContent = "Please add a travel note since you chose multiple campuses.";
    return;
  }

  if (type === "many" && selectedCampuses.length < 2) {
    output.textContent = "Please choose at least two campuses since you selected 'Two or more campuses'.";
    return;
  }
